# Meow-HackTheBox-Starter-Lab


## Objective

The objective this lab is to introduce beginners to the fundamentals of penetration testing and ethical hacking by guiding them through a safe, controlled virtual environment. The lab focuses on:

- Discovering services, users, and potential attack vectors.
- Exploiting simple vulnerabilities to gain access.
- Moving from limited access to administrative/root control.
- Reinforcing safe practices in a beginner-friendly scenario.
